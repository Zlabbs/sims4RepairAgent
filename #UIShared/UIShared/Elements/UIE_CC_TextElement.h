...
namespace UIShared
{
	class UIE_CC_TextElement : public stackExternal::UI::UIElement, UIComponent_ConnectionContext
	{
	protected:
		...
		virtual void OnRender(void* renderingContext, bool renderDebug) override
		{
			...
			//renders text
			SDL_SetRenderDrawColor((SDL_Renderer*)renderingContext, m_textColor.r, m_textColor.g, m_textColor.b, m_textColor.a);
		...
		virtual void LoadPropities(void* propertyContext, char* loadFromBuffer, unsigned int bufferLength) override
		{
			...
			m_textColor.r = colorArray.GetSubObjectByArrayElement(0).GetContentsInt();
			m_textColor.g = colorArray.GetSubObjectByArrayElement(1).GetContentsInt();
			m_textColor.b = colorArray.GetSubObjectByArrayElement(2).GetContentsInt();
			m_textColor.a = colorArray.GetSubObjectByArrayElement(3).GetContentsInt();
		}
	...
	public:
		...
		SDL_Color m_textColor = SDL_Color();
	};
}